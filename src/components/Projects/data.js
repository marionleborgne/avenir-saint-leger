...
export default [
  ...
  // Notre environnement
  {
    ...
    shortTerm: <div>{`Mettre en place une zone test  près des poubelles de la place du Gros Billot`}</div>,
    longTerm: ''
  },
  {
  ...
  },
  {
    ...
    shortTerm: <div>{`Végétalisation du cimetière`}</div>,
    longTerm: ''
  },
  // Les équilibres financiers
  {
    ...
    shortTerm: '',
    longTerm: '',
    learnMore: <div>{`Maintenir le taux des taxes locales
    Pas de démarrage de travaux avant la notification de subventions`}</div>
  },
  {
